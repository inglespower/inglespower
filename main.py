...
def hablar(call_id, texto):
    ...
    try:
        # --- NUEVA LÓGICA V2 MÁS SEGURA ---
        # Usamos convert() que es el método directo de la API
        ...
        print(f"[EXITO] Audio generado: {filename}")
