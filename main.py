...
from ai import generar_respuesta  # tu función que genera texto de respuesta
...
# --- Generar audio ElevenLabs (ulaw 8kHz) ---
...
async def webhook(request: Request):
    try:
        ...
        if event_type == "call.initiated" and call_id:
            ...
            # Generar y reproducir bienvenida
            bienvenida = "¡Hola! Soy InglesPower, tu asistente para aprender inglés."
        ...
        # --- Media terminada (usuario deja de hablar) ---
