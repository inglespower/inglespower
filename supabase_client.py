...
def conectar_db():
    ...
    Evita errores si las variables de entorno no están configuradas.
    """
...
def obtener_minutos(phone):
    ...
    Retorna 0 si no existe el usuario o hay un error.
    """
    db = conectar_db()
    if not db:
        return 0
    try:
        ...
        print("DEBUG obtener_minutos res:", res.data)  # Debug
...
def restar_minuto(phone):
    """
    Resta un minuto al usuario usando la función RPC 'decrement_minutes' en Supabase.
    ...
    try:
        ...
        print("DEBUG restar_minuto res:", res.data)  # Debug
        return True
    except Exception as e:
